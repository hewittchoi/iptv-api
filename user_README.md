...
- ✅ demo里频道设置不同的别名，发现都是匹配到相同的直播源，所以应该不是完全匹配demo频道名称。希望白名单也能实现这一功能，而不是白名单要完全匹配频道名称，而且只能匹配一条。
- ✅ 本地源里明明有可以播的源，自动更新反而匹配不到
- ✅ 本地源里属于别名的，也匹配不到？
- ✅ 单个接口测速超时时长，设置里说“数值越大测速所属时间越长，能提高获取接口数量，但质量会有所下降；数值越小测速所需时间越短，能获取低延时的接口，质量较好；调整此值能优化更新时间”，实际上测速越小好像获取了太长会卡顿的源，有些源可以初始有点慢，但后续很快很稳定。
- ✅ 
- ✅ 
- ✨ 更多功能请见
